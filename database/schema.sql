...
-- =====================================================
-- 12. Indoor navigation domain
-- =====================================================
-- Indoor navigation shares tourism_system. Provider fields keep official AMap
-- indoor capability and local graph fallback in one formal data model.
CREATE TABLE indoor_buildings (
    id SERIAL PRIMARY KEY,
    scenic_spot_id INTEGER NOT NULL REFERENCES scenic_spots(id) ON DELETE CASCADE,
...
CREATE TABLE indoor_route_audit (
    id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_indoor_buildings_spot ON indoor_buildings(scenic_spot_id);
CREATE INDEX idx_indoor_buildings_provider ON indoor_buildings(provider);
CREATE INDEX idx_indoor_floors_building ON indoor_floors(building_id);
CREATE INDEX idx_indoor_features_building ON indoor_features(building_id);
CREATE INDEX idx_indoor_features_floor ON indoor_features(floor_id);
CREATE INDEX idx_indoor_features_type ON indoor_features(type);
CREATE INDEX idx_indoor_edges_building ON indoor_edges(building_id);
CREATE INDEX idx_indoor_edges_from ON indoor_edges(from_feature_id);
CREATE INDEX idx_indoor_edges_to ON indoor_edges(to_feature_id);
CREATE INDEX idx_indoor_route_audit_building ON indoor_route_audit(building_id);
